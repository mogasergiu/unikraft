...
#define UK_EFI_MEMORY_ATTRIBUTES_TABLE_GUID					\
	&(uk_efi_guid_t){							\
		...
		.b4_5 = 0x26eb,							\
		.b6_7 = 0x469f,							\
		.b8_15 = {0xa2, 0x20, 0x38, 0xb7, 0xdc, 0x46, 0x12, 0x20},	\
	}
...
#define UK_EFI_ACPI10_TABLE_GUID						\
	&(uk_efi_guid_t){							\
		...
		.b4_5 = 0x2d88,							\
		.b6_7 = 0x11d3,							\
		.b8_15 = {0x9a, 0x16, 0x00, 0x90, 0x27, 0x3f, 0xc1, 0x4d},	\
	}
#define UK_EFI_ACPI20_TABLE_GUID						\
	&(uk_efi_guid_t){							\
		...
		.b4_5 = 0xe4f1,							\
		.b6_7 = 0x11d3,							\
		.b8_15 = {0xbc, 0x22, 0x00, 0x80, 0xc7, 0x3c, 0x88, 0x81},	\
	 }
...
#define UK_EFI_FILE_INFO_ID_GUID						\
	&(uk_efi_guid_t){							\
		...
		.b4_5 = 0x6d3f,							\
		.b6_7 = 0x11d2,							\
		.b8_15 = {0x8e, 0x39, 0x00, 0xa0, 0xc9, 0x69, 0x72, 0x3b},	\
	}
...
#define UK_EFI_FILE_SYSTEM_VOLUME_LABEL_ID_GUID					\
	&(uk_efi_guid_t){							\
		...
		.b4_5 = 0xfe81,							\
		.b6_7 = 0x11d3,							\
		.b8_15 = {0x9a, 0x35, 0x00, 0x90, 0x27, 0x3f, 0xc1, 0x4d},	\
	}
...
typedef struct uk_efi_file_prot {
	__u64 revision;

	uk_efi_status_t
	(__uk_efi_api *open)(struct uk_efi_file_prot *this,
			     struct uk_efi_file_prot **new_hndl,
			     __s16 *file_name,
			     __u64 open_mode,
			     __u64 attr);

	uk_efi_status_t
	(__uk_efi_api *close)(struct uk_efi_file_prot *this);

	uk_efi_status_t
	(__uk_efi_api *delete)(struct uk_efi_file_prot *this);

	uk_efi_status_t
	(__uk_efi_api *read)(struct uk_efi_file_prot *this,
			     uk_efi_uintn_t *buf_sz,
			     void *buf);

	uk_efi_status_t
	(__uk_efi_api *write)(struct uk_efi_file_prot *this,
			      uk_efi_uintn_t *buf_sz,
			      void *buf);

	uk_efi_status_t
	(__uk_efi_api *get_position)(struct uk_efi_file_prot *this,
				     __u64 *pos);

	uk_efi_status_t
	(__uk_efi_api *set_position)(struct uk_efi_file_prot *this,
				     __u64 *pos);

	uk_efi_status_t
	(__uk_efi_api *get_info)(struct uk_efi_file_prot *this,
				 uk_efi_guid_t *info_type,
				 uk_efi_uintn_t *buf_sz,
				 void *buf);

	uk_efi_status_t
	(__uk_efi_api *set_info)(struct uk_efi_file_prot *this,
				 uk_efi_guid_t *info_type,
				 uk_efi_uintn_t buf_sz,
				 void *buf);

	uk_efi_status_t
	(__uk_efi_api *flush)(struct uk_efi_file_prot *this);


	uk_efi_status_t
	(__uk_efi_api *open_ex)(struct uk_efi_file_prot *this,
				struct uk_efi_file_prot **new_hndl,
				__s16 *file_name,
				__u64 open_mode,
				__u64 attr,
	...
	uk_efi_status_t
	(__uk_efi_api *read_ex)(struct uk_efi_file_prot *this,
				uk_efi_file_io_token_t *token);

	uk_efi_status_t
	(__uk_efi_api *write_ex)(struct uk_efi_file_prot *this,
				 uk_efi_file_io_token_t *token);

	uk_efi_status_t
	(__uk_efi_api *flush_ex)(struct uk_efi_file_prot *this,
				 uk_efi_file_io_token_t *token);
} uk_efi_file_prot_t;
...
typedef struct uk_efi_simple_fs_prot {
	__u64 revision;
	uk_efi_status_t
	(__uk_efi_api *open_volume)(struct uk_efi_simple_fs_prot *this,
				    uk_efi_file_prot_t **root);
} uk_efi_simple_fs_prot_t;
